...
//                currentWinTeam = 2
//            }
//            goalTime = strToTime(info[1])
//        } else if (currentWinTeam == 1) {
//            if (info[0] == "1") {
//                goal1 += 1
//            } else {
//                goal2 += 1
//                if (goal1 == goal2) {
//                    winTime1 += strToTime(info[1]) - goalTime
//                    currentWinTeam = 0
//                }
//            }
//        } else {
...
//                goal1 += 1
//                if (goal1 == goal2) {
//                    winTime2 += strToTime(info[1]) - goalTime
//                    currentWinTeam = 0
//                }
//            } else if (info[0] == "2") {
//                goal2 += 1
...
//        if (i == goalNum) {
//            if (currentWinTeam == 1)
//                winTime1 += strToTime("48:00") - goalTime
//            if (currentWinTeam == 2)
//                winTime2 += strToTime("48:00") - goalTime
//        }
//    }
//
//    println(timeToStr(winTime1))
